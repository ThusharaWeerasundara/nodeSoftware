...
uint8_t pin_led = 16;
char* ssid = "SLT-LTE-WiFi-F17A";
char* password = "JAER56DYDH5";
...
String ip = "http://3.88.221.195/";
String rest = "readings/";
String initialize = ip + "/setup/" + "id";
//String URL = ip + rest;

String URL = "http://54.147.30.110/readings/{\"email\": \"thusharaweerasundara@gmail.com\", \"no\":\"3\"}";
